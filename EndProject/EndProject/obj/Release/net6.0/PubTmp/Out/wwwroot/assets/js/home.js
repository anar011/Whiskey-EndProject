$(document).ready(function () {
  ...
  search.addEventListener("click", function (e) {
    ...
    let Searchh = document.querySelector(".header-search a i")
    Searchh.addEventListener("click", function (e) {
        e.preventDefault()
        document.querySelector(".header-search button").classList.toggle("d-none")
    });
